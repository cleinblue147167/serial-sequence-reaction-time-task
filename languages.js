...
const zh = {
    ...
    instruction: {
        fourCircles: "在此任务中，屏幕上将出现四个圆圈。从左到右，按键 <strong>'S'</strong>、<strong>'F'</strong>、<strong>'J'</strong> 和 <strong>'L'</strong> 分别对应这四个圆圈。",
        dog: "不时地，某个圆圈中会出现一张 <b>狗的图片</b>。",
        yourTask: "你的任务是通过尽可能 <strong>快速且准确</strong> 地按下对应狗出现位置的按键来“抓住狗”。",
        restBetweenBlocks: "每隔几分钟会有一次短暂暂停，我们会显示你的平均准确率和反应时，你可以利用这些信息来改善表现。",
        img: "<img src='static/images/ASRT_en.gif' width='30%' alt='Dalmata'/>"
    },
    instruction2: {
        firstButton: "你需要用左手中指按下 <strong>'S'</strong> 键，",
        secondButton: "用左手食指按下 <strong>'F'</strong> 键，",
        thirdButton: "用右手食指按下 <strong>'J'</strong> 键，",
        fourthButton: "用右手中指按下 <strong>'L'</strong> 键。",
        ifClear: "如果说明清楚，请点击 <strong>下一步</strong>；如果不清楚，可点击 <strong>上一步</strong> 返回检查指示。"
    },
    practice: {
        startPractice: "如果你准备好了，按下 <strong>任意</strong> 键开始练习！",
        practiceSoon: "现在将开始一个简短的练习。"
    },
    task: {
        realTask: "正式任务现在开始。",
        startTask: "如果你准备好了，按下 <strong>任意</strong> 键开始任务！",
        nextBlock: "按任意键开始下一个区块！",
        nextBlockSoon: "下一个区块即将开始。",
        place: "请将手指放在键盘的以下位置："
    },
    end: {
        endTask: "实验结束。",
    ...
    fullscreen: {
        fullscreenText: "当你按下下面的按钮时，实验将切换为全屏模式。",
        fullscreenButton: "继续"
    },
    parameters: {
        subject: "被试编号：",
    ...
    startWarning: {
        startSubject: "你即将以 <strong>被试编号 ",
        startSession: "</strong> 和 <strong>会话编号 ",
        startButton: "开始任务！",
        goBackButton: "修改参数"
    },
    warning: {
        warning: "注意！",
        accuracy: "你在整个任务期间的准确率：",
        onlyValid: "若最终准确率未超过 80%，我们将无法接受你的提交！",
        moreAccurate: "请尽量提高准确性！",
        pressButton: "请按任意键继续！"
    }
}
