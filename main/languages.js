...
const zh = {
    welcomePage: {
        welcome: "欢迎!",
        clickNext: "点击<strong>下一步</strong>继续。"
    },
    instruction: {
        fourCircles: "在这个任务中，你将在屏幕上看到四个圆圈。从左到右，<strong>'S'</strong>、<strong>'F'</strong>、<strong>'J'</strong>和<strong>'L'</strong>键分别对应这四个圆圈。",
        dog: "不时地，一个<b>小狗的图像</b>会出现在其中一个圆圈中。",
        yourTask: "你的任务是通过按下对应小狗位置的按键来'捉住小狗'。请<strong>尽可能又快又准确地</strong>完成任务。",
        restBetweenBlocks: "每隔几分钟会有一个短暂的休息，我们会显示你的平均准确率和反应时间，你可以用这些信息来提高你的表现。",
        img: "<img src='../static/images/ASRT_en.gif' width='30%' alt='Dalmata'/>"
    },
    instruction2: {
        firstButton: "你需要用左手中指按<strong>'S'</strong>键，",
        secondButton: "用左手食指按<strong>'F'</strong>键，",
        thirdButton: "用右手食指按<strong>'J'</strong>键，",
        fourthButton: "用右手中指按<strong>'L'</strong>键。",
        ifClear: "如果指示说明清楚了，请点击<strong>下一步</strong>；如果不清楚，你可以点击<strong>上一步</strong>重新查看指示。"
    },
    practice: {
        startPractice: "如果你准备好了，按<strong>任意</strong>键开始练习!",
        practiceSoon: "现在将开始一个简短的练习。"
    },
    task: {
        realTask: "正式任务现在开始。",
        startTask: "如果你准备好了，按<strong>任意</strong>键开始任务！",
        nextBlock: "按任意键开始下一组任务！",
        nextBlockSoon: "下一组任务即将开始。",
        place: "请将你的手指放在键盘上的这个位置："
    },
    end: {
        endTask: "实验结束。",
        thankYou: "谢谢参与！"
    ...
    fullscreen: {
        fullscreenText: "当你点击下面的按钮后，实验将切换到全屏模式。",
        fullscreenButton: "继续"
    },
    parameters: {
        subject: "受试者编号：",
    ...
    startWarning: {
        startSubject: "你即将开始任务，<strong>受试者编号为",
        startSession: "</strong>，<strong>实验场次为",
        startButton: "开始任务！",
        goBackButton: "修改参数"
    },
    warning: {
        warning: "警告！",
        accuracy: "你在整个任务中的准确率：",
        onlyValid: "只有当你的准确率在任务结束时超过80%时，我们才能接受你的提交！",
        moreAccurate: "请努力提高准确率！",
        pressButton: "请按任意按钮继续！"
    }
}